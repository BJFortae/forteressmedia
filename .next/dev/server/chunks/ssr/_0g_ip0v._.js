...
;
const metadata = {
    title: "Forteress Media | AI-first websites, apps, and media systems",
    description: "Forteress Media helps organizations rebuild websites, apps, and digital workflows with AI-first strategy and implementation."
};
